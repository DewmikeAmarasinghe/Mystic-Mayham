...
import HomeGrounds.HomeGroundFactory;
...
public class Combat {
    ...
    public Combat(Player player1, Player player2) {
        System.out.println("\n=== Initializing Combat ===");
        System.out.println("Player 1: " + player1.getName() + " (Home Ground: " + player1.getHomeGround() + ")");
        System.out.println("Player 2: " + player2.getName() + " (Home Ground: " + player2.getHomeGround() + ")");
        ...
        // Get home ground string from player1 and convert to HomeGround object
        String homeGroundName = player1.getHomeGround();
        System.out.println("Player 1's home ground: " + homeGroundName);
        
        if (homeGroundName != null && !homeGroundName.isEmpty()) {
            this.homeGround = HomeGroundFactory.getHomeGround(homeGroundName);
            System.out.println("Home ground object created: " + this.homeGround.getClass().getSimpleName());
        } else {
            // Default to Marshland if no home ground is set
            this.homeGround = new Marshland("Marshland");
            System.out.println("Warning: No home ground set for player. Defaulting to Marshland.");
        }
        
        initializeTurnOrder();
        initializeTargetOrder();
        
        System.out.println("Turn order initialized with " + turnOrder.size() + " characters");
        System.out.println("Target order 1 size: " + targetOrder1.size());
        System.out.println("Target order 2 size: " + targetOrder2.size());
        System.out.println("Combat initialization complete\n");
    }
